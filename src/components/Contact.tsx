...
export function Contact() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-md rounded-lg shadow-input overflow-hidden">
      ...
      {/* Background gradient */}
      <div className="absolute inset-0 scale-90 rounded-full bg-gradient-to-r from-blue-500 to-teal-500 blur-3xl" />   

      {/* Card content */}
      <div className="relative z-10 rounded-lg bg-neutral-50 p-4 md:rounded-2xl md:p-8 dark:bg-neutral-900">
